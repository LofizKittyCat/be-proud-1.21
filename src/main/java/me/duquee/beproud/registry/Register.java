...
public class Register {
    ...
    public static <T extends Block> BlockBuilder<T> block(String name, Function<AbstractBlock.Settings, T> factory) {
    ...
    public static <P extends ItemBuilder<T, P>, T extends Item> ItemBuilder<T, P> item(String name, Function<Item.Settings, T> factory) {
    ...
    public static <T extends BlockEntity, S extends BlockEntityRenderState> BlockEntityBuilder<T, S> blockEntity(String name, FabricBlockEntityTypeBuilder.Factory<T> factory) {
    ...
    public static <T extends ScreenHandler, D extends ScreenHandlerType<T>> ExtendedScreenHandlerType<T, D> registerExtendedScreenHandler(String name, ExtendedScreenHandlerType.ExtendedFactory<T, D> factory) {
        ExtendedScreenHandlerType<T, D> handlerType = new ExtendedScreenHandlerType<>(factory, factory.);
