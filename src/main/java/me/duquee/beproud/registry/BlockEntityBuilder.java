...
public class BlockEntityBuilder<T extends BlockEntity, S extends BlockEntityRenderState> {
    ...
    private Function<BlockEntityRendererFactory.Context, BlockEntityRenderer<T, S>> renderer;
    ...
    public BlockEntityBuilder<T, S> blocks(Block... blocks) {
        this.blocks = blocks;
        return this;
    }

    public BlockEntityBuilder<T, S> renderer(Supplier<Function<BlockEntityRendererFactory.Context, BlockEntityRenderer<T, S>>> factory) {
        if (isClient()) this.renderer = factory.get();
        return this;
    }

    public BlockEntityBuilder<T, S> register() {
        if (blocks == null) {
